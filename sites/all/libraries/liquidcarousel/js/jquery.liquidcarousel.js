...
(function($){
    ...
    return this.each(function() {
			...
			var totalwidth = liwidth + additionalmargin-1;
			...
			$(window).resize(function(e){
				...
				totalwidth = liwidth + additionalmargin-1;

				$('> .wrapper > ul > li', divobj).css('marginRight', originalmarginright + halfadditionalmargin-0.5);
				$('> .wrapper > ul > li', divobj).css('marginLeft',originalmarginleft + halfadditionalmargin-0.5);
