...
*/
  ...
  // second menu display or hide
  Drupal.behaviors.secondmenu = {
    attach: function (context) {
      $(document).ready(function(){
        $('#block-menu-menu-second', context).hide();
      });
      var mainmenufirst=$('header #main-menu .menu li.first', context);
      var menusecond=$('#block-menu-menu-second', context);
      mainmenufirst.mouseover(function (){
        menusecond.show();
      });
      menusecond.mouseover(function (){
        menusecond.show();
      });
      menusecond.mouseout(function (){
        menusecond.hide();
      });
      mainmenufirst.mouseleave(function (){
        menusecond.hide();
      });
    }
  };
