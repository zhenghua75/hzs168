var app = (function(my) {
    ...
    my.updateApp = function() {
        ...
        //         try {
        //             fileSystem.root.getFile('zlsxjj1440489378.apk', {
        //                 create: true,
        //                 exclusive: false
        //             }, function(fileEntry) {
        //                 var localPath = fileEntry.toURL(),
        //                     fileTransfer = new FileTransfer();
        //                 fileTransfer.download('http://ylst.kmdx.cn:9000/download/zlsxjj1440489378/zlsxjj1440489378.apk', localPath, function(entry) {
        ...
        //                 }, function(error) {
        //                     alert("Error downloading APK: " + JSON.stringify(error));
        //                 });
        //             }, function(evt) {
        ...
        //         }
        //     }, function(e) {
        //         alert("Error preparing to download apk: " + e.target.error.code);
        //         var msg = '';
        //         switch (e.code) {
    ...
    my.receivedEvent = function(id) {
        ...
        if (device.platform == 'android' || device.platform == 'Android') {
            base.ajax(false, {
                url: 'http://www.hzs168.com/app/autoupdate/index.php?v[app/zlsxjj1440489378.apk]=1.0.26',
